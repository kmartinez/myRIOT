/*
* range tester - adapted from radio test code
 ...
 * adapted as range tester sending incrementing counter
 * @}
#define CONFIG_IEEE802154_DEFAULT_TXPOWER 8
 */
/* not sure which power number is max as it could be 36 */
#include <stdio.h>
